...
public class LoginManager implements EntryPoint {
	public void onModuleLoad() {
		...
		horizontalPanel.setSize("577px", "289px");
		
		VerticalPanel verticalPanel = new VerticalPanel();
		horizontalPanel.add(verticalPanel);
		verticalPanel.setSize("260px", "136px");
		
		Label lblNewLabel = new Label("Welcome to my Login Page...");
		lblNewLabel.setStyleName("gwt-label-login");
		verticalPanel.add(lblNewLabel);
		lblNewLabel.setHeight("43px");
		
		Login login = new Login();
		horizontalPanel.add(login);
		login.setSize("284px", "122px");
	}
}
