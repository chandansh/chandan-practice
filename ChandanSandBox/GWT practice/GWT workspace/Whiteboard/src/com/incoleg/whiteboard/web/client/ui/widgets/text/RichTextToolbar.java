...
public class RichTextToolbar extends Composite
{
	...
	private MathsEditor meditor;
	private DialogBox equationBox = new DialogBox(false, true);

	private Whiteboard wboard;
	private DialogBox wboardBox = new DialogBox(false, true);
	...
	private class EventHandler implements ClickHandler, ChangeHandler, KeyUpHandler
	{
		...
		public void onChange(ChangeEvent event)
		{
			...
			} else if(sender == symbols)
			{
				...
				// show the MathsEditor (in a dialog), get the image and "insert" the image
			}
		}
	...
	public RichTextToolbar(RichTextArea richText)
	{
		...
		if(basic != null)
		{
			...
			bottomPanel.add(symbols = createSymbolsList());
	...
	private ListBox createSymbolsList()
	{
		ListBox smb = new ListBox(false);
		smb.setVisibleItemCount(1);
		smb.addChangeHandler(handler);
		smb.addItem(strings.insert(), "");
		smb.addItem(strings.equation(), "equation");
		//smb.addItem(strings.whiteboard(), "whiteboard");

		initMathsEditor();
		return smb;
	}

	private void initMathsEditor()
	{
		VerticalPanel vp = new VerticalPanel();
		if(meditor == null)
		{
			meditor = new MathsEditor();
		}
		meditor.setValue("");
		vp.add(meditor);
		...
		okBtn.addClickHandler(new ClickHandler()
		{
			...
			public void onClick(ClickEvent event)
			{
				basic.insertImage(meditor.getEquationImageURL());
				equationBox.hide();
			}
		});
		...
		equationBox.setWidget(vp);
		equationBox.setWidth("510px");
		equationBox.addCloseHandler(new CloseHandler<PopupPanel>()
		{
			@Override
