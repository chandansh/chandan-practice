...
public class HelloWorldServiceServiceLocator extends org.apache.axis.client.Service implements com.service.HelloWorldServiceService {
    ...
    private java.lang.String HelloWorldService_address = "http://localhost:8080/WebServiceProject/services/HelloWorldService";
    ...
    public com.service.HelloWorldService getHelloWorldService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.service.HelloWorldServiceSoapBindingStub _stub = new com.service.HelloWorldServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.service.HelloWorldService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.service.HelloWorldServiceSoapBindingStub _stub = new com.service.HelloWorldServiceSoapBindingStub(new java.net.URL(HelloWorldService_address), this);
                _stub.setPortName(getHelloWorldServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.com", "HelloWorldServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.com", "HelloWorldService"));
        }
