...
import com.coleg.model.CustomerClp;
...
public class ClpSerializer {
	public static final String SERVLET_CONTEXT_NAME = "MyLiferay-portlet";
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(CustomerClp.class.getName())) {
			...
			try {
				...
				try {
					Class<?> newModelClass = Class.forName("com.coleg.model.impl.CustomerImpl",
							true, _classLoader);
					...
					Method method2 = newModelClass.getMethod("setCompany",
							new Class[] { String.class });

					String value2 = oldCplModel.getCompany();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.coleg.model.impl.CustomerImpl")) {
			ClassLoader contextClassLoader = Thread.currentThread()
												   .getContextClassLoader();
			...
			try {
				...
				try {
					...
					Method method2 = oldModelClass.getMethod("getCompany");

					String value2 = (String)method2.invoke(oldModel,
							(Object[])null);

					newModel.setCompany(value2);
