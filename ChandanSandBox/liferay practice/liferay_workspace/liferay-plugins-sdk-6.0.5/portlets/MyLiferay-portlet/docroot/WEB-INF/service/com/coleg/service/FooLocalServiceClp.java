...
public class FooLocalServiceClp implements FooLocalService {
	...
	public com.coleg.model.Foo addFoo(com.coleg.model.Foo foo)
		...
		return (com.coleg.model.Foo)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.coleg.model.Foo> getFoos(int start, int end)
		...
		return (java.util.List<com.coleg.model.Foo>)ClpSerializer.translateOutput(returnObj);
	}
	...
	private MethodKey _addFooMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
			"addFoo", com.coleg.model.Foo.class);
	...
	private MethodKey _deleteFooMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteFoo", com.coleg.model.Foo.class);
	...
	private MethodKey _updateFooMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
			"updateFoo", com.coleg.model.Foo.class);
	private MethodKey _updateFooMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
			"updateFoo", com.coleg.model.Foo.class, boolean.class);
}