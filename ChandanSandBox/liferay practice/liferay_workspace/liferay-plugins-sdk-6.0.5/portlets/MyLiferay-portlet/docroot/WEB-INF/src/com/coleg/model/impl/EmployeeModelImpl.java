...
/**
 * The base model implementation for the Employee service. Represents a row in the &quot;myportlet_coleg_Employee&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class EmployeeModelImpl extends BaseModelImpl<Employee>
	...
	public static final String TABLE_NAME = "myportlet_coleg_Employee";
	public static final Object[][] TABLE_COLUMNS = {
			{ "id_", new Integer(Types.VARCHAR) },
			{ "name", new Integer(Types.VARCHAR) },
			{ "address", new Integer(Types.VARCHAR) }
		};
	public static final String TABLE_SQL_CREATE = "create table myportlet_coleg_Employee (id_ VARCHAR(75) not null primary key,name VARCHAR(75) null,address VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table myportlet_coleg_Employee";
