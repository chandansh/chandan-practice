 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.slayer.service.impl.PostLocalServiceImpl}.
 * </p>
 *
 * @author Chandan
...
public abstract class PostLocalServiceBaseImpl implements PostLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.slayer.service.PostLocalServiceUtil} to access the post local service.
	 */
	...
	public Post addPost(Post post) throws SystemException {
		...
		post = postPersistence.update(post, false);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deletePost(long postId) throws PortalException, SystemException {
		Post post = postPersistence.remove(postId);
	...
	public Post updatePost(Post post, boolean merge) throws SystemException {
		...
		post = postPersistence.update(post, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.slayer.model.Post",
			postLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.slayer.model.Post");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(PostLocalServiceBaseImpl.class);
