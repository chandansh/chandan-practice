...
public class AddressUtil {
	...
	*/
	public static void cacheResult(com.test.slayer.model.Address address) {
	...
	*/
	public static void cacheResult(
		java.util.List<com.test.slayer.model.Address> addresses) {
	...
	*/
	public static com.test.slayer.model.Address create(long addId) {
		return getPersistence().create(addId);
	}
	...
	* @throws com.test.slayer.NoSuchAddressException if a address with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.slayer.model.Address remove(long addId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.test.slayer.NoSuchAddressException {
		return getPersistence().remove(addId);
	}

	public static com.test.slayer.model.Address updateImpl(
	...
	/**
	* Returns the address with the primary key or throws a {@link com.test.slayer.NoSuchAddressException} if it could not be found.
	*
	* @param addId the primary key of the address
	* @return the address
	* @throws com.test.slayer.NoSuchAddressException if a address with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.slayer.model.Address findByPrimaryKey(long addId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.test.slayer.NoSuchAddressException {
		return getPersistence().findByPrimaryKey(addId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.slayer.model.Address fetchByPrimaryKey(long addId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(addId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.test.slayer.model.Address> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static AddressPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (AddressPersistence)PortletBeanLocatorUtil.locate(com.test.slayer.service.ClpSerializer.getServletContextName(),
