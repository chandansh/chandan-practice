						...
						<c:choose>
							<c:when test="<%= multipleSubmissions || !(DDLFormUtil.hasSubmitted(request, recordSet.getRecordSetId())) %>">
								<aui:fieldset>
									...
									System.out.println("DDM structure xml \n"+ddmStructure.getXsd());
									//System.out.println("\nhtml\n"+DDMXSDUtil.getHTML(pageContext, ddmStructure.getXsd(), locale));
									
									DLFileEntry dlentry = DLFileEntryLocalServiceUtil.getFileEntry(13212);
									
									Document doc = SAXReaderUtil.read(dlentry.getContentStream());
									
									System.out.print("Doc xml: \n"+doc.asXML());
									System.out.println("\nhtml\n"+DDMXSDUtil.getHTML(pageContext, doc.asXML(), locale));
									%>
