...
import com.liferay.test.model.EmployeeClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"TestPlugin-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "TestPlugin-portlet";
			}
	...
	public static Object translateInputEmployee(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("com.liferay.test.model.impl.EmployeeImpl",
						true, _classLoader);
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.liferay.test.model.impl.EmployeeImpl")) {
