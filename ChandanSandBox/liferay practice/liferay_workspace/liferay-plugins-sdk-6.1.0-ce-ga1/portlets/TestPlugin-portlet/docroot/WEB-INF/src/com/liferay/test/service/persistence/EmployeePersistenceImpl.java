...
import com.liferay.test.model.impl.EmployeeImpl;
import com.liferay.test.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
	...
	@Override
	public Employee updateImpl(com.liferay.test.model.Employee employee,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Employee fetchByPrimaryKey(long id) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Employee[] findByName_PrevAndNext(long id, String name,
		OrderByComparator orderByComparator)
		throws NoSuchEmployeeException, SystemException {
	...
	protected Employee getByName_PrevAndNext(Session session,
		Employee employee, String name, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByName(String name) throws SystemException {
		for (Employee employee : findByName(name)) {
			remove(employee);
		}
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.test.model.Employee")));
