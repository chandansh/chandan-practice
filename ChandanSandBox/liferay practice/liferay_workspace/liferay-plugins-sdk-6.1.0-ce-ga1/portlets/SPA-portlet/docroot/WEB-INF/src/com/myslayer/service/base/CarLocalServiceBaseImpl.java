 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.myslayer.service.impl.CarLocalServiceImpl}.
 * </p>
 *
 * @author Chandan
...
public abstract class CarLocalServiceBaseImpl implements CarLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.myslayer.service.CarLocalServiceUtil} to access the car local service.
	 */
	...
	public Car addCar(Car car) throws SystemException {
		...
		car = carPersistence.update(car, false);
	...
	public void deleteCar(long carId) throws PortalException, SystemException {
		Car car = carPersistence.remove(carId);
	...
	public Car updateCar(Car car, boolean merge) throws SystemException {
		...
		car = carPersistence.update(car, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.myslayer.model.Car",
			carLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.myslayer.model.Car");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(CarLocalServiceBaseImpl.class);
