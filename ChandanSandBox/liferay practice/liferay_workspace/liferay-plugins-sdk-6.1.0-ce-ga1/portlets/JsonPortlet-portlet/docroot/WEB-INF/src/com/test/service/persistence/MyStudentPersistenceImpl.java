...
import com.test.NoSuchMyStudentException;

import com.test.model.MyStudent;
import com.test.model.impl.MyStudentImpl;
import com.test.model.impl.MyStudentModelImpl;
...
public class MyStudentPersistenceImpl extends BasePersistenceImpl<MyStudent>
	 ...
	 */
	public MyStudent remove(long id)
	...
	protected MyStudent removeImpl(MyStudent myStudent)
		...
		try {
			...
			BatchSessionUtil.delete(session, myStudent);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	@Override
	public MyStudent updateImpl(com.test.model.MyStudent myStudent,
		...
		try {
			...
			BatchSessionUtil.update(session, myStudent, merge);
	...
	protected MyStudent toUnwrappedModel(MyStudent myStudent) {
		...
		myStudentImpl.setId(myStudent.getId());
		myStudentImpl.setName(myStudent.getName());
	 ...
	 * @throws com.liferay.portal.NoSuchModelException if a my student with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MyStudent findByPrimaryKey(long id)
		throws NoSuchMyStudentException, SystemException {
		MyStudent myStudent = fetchByPrimaryKey(id);
		...
		if (myStudent == null) {
			...
			try {
				...
				if (myStudent != null) {
					...
					EntityCacheUtil.putResult(MyStudentModelImpl.ENTITY_CACHE_ENABLED,
						MyStudentImpl.class, id, _nullMyStudent);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.test.model.MyStudent")));
