...
/**
 * The persistence utility for the shopping cart ext service. This utility wraps {@link ShoppingCartExtPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class ShoppingCartExtUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ShoppingCartExt shoppingCartExt) {
		getPersistence().clearCache(shoppingCartExt);
	}
	 ...
	 */
	public static List<ShoppingCartExt> findWithDynamicQuery(
	 ...
	 */
	public static ShoppingCartExt update(ShoppingCartExt shoppingCartExt,
		boolean merge) throws SystemException {
		return getPersistence().update(shoppingCartExt, merge);
	}
	...
	public static ShoppingCartExt update(ShoppingCartExt shoppingCartExt,
		...
		return getPersistence().update(shoppingCartExt, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(shoppingCartExt);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(shoppingCartExts);
	}
	...
	*/
	public static com.slayer.model.ShoppingCartExt create(long recId) {
	...
	*/
	public static com.slayer.model.ShoppingCartExt remove(long recId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.slayer.NoSuchShoppingCartExtException {
		return getPersistence().remove(recId);
	}

	public static com.slayer.model.ShoppingCartExt updateImpl(
		com.slayer.model.ShoppingCartExt shoppingCartExt, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(shoppingCartExt, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.slayer.model.ShoppingCartExt findByPrimaryKey(long recId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.slayer.NoSuchShoppingCartExtException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.slayer.model.ShoppingCartExt fetchByPrimaryKey(long recId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.slayer.model.ShoppingCartExt> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ShoppingCartExtPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ShoppingCartExtPersistence)PortletBeanLocatorUtil.locate(com.slayer.service.ClpSerializer.getServletContextName(),
					ShoppingCartExtPersistence.class.getName());

			ReferenceRegistry.registerReference(ShoppingCartExtUtil.class,
				"_persistence");
		}
	...
	public void setPersistence(ShoppingCartExtPersistence persistence) {
	...
	private static ShoppingCartExtPersistence _persistence;
}