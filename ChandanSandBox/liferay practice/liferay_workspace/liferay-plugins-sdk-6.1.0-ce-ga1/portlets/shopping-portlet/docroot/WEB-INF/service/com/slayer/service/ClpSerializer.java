...
public class ClpSerializer {
	...
	public static Object translateInputShoppingCartExt(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("com.slayer.model.impl.ShoppingCartExtImpl",
						true, _classLoader);

				Object newModel = newModelClass.newInstance();

				Method method0 = newModelClass.getMethod("setRecId",
						new Class[] { Long.TYPE });
				...
				Method method1 = newModelClass.getMethod("setCartId",
						new Class[] { Long.TYPE });
				...
				Method method3 = newModelClass.getMethod("setAmount",
	...
	public static Object translateInputShoppingCategoryExt(
		BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("com.slayer.model.impl.ShoppingCategoryExtImpl",
						true, _classLoader);
				...
				Method method1 = newModelClass.getMethod("setImageId",
						new Class[] { Long.TYPE });
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.slayer.model.impl.ShoppingCartExtImpl")) {
			return translateOutputShoppingCartExt(oldModel);
		}

		if (oldModelClassName.equals(
					"com.slayer.model.impl.ShoppingCategoryExtImpl")) {
	...
	public static Object translateOutputShoppingCategoryExt(
		BaseModel<?> oldModel) {
		Thread currentThread = Thread.currentThread();
