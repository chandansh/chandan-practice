...
/**
 * The base implementation of the member address local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.library.slayer.service.impl.MemberAddressLocalServiceImpl}.
 * </p>
 *
 * @author Ahmed Hasan
 ...
 * @generated
 */
public abstract class MemberAddressLocalServiceBaseImpl
	implements MemberAddressLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.library.slayer.service.MemberAddressLocalServiceUtil} to access the member address local service.
	 */
	...
	public MemberAddress addMemberAddress(MemberAddress memberAddress)
		...
		memberAddress = memberAddressPersistence.update(memberAddress, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(memberAddress);
			}
	 ...
	 */
	public MemberAddress createMemberAddress(long userId) {
		return memberAddressPersistence.create(userId);
	}
	...
	public void deleteMemberAddress(long userId)
		...
		MemberAddress memberAddress = memberAddressPersistence.remove(userId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(memberAddress);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteMemberAddress(MemberAddress memberAddress)
		throws SystemException {
		memberAddressPersistence.remove(memberAddress);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return memberAddressPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return memberAddressPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public MemberAddress fetchMemberAddress(long userId)
		throws SystemException {
		return memberAddressPersistence.fetchByPrimaryKey(userId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberAddress getMemberAddress(long userId)
		throws PortalException, SystemException {
		return memberAddressPersistence.findByPrimaryKey(userId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return memberAddressPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MemberAddress> getMemberAddresses(int start, int end)
		throws SystemException {
		return memberAddressPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getMemberAddressesCount() throws SystemException {
		return memberAddressPersistence.countAll();
	}
	...
	public MemberAddress updateMemberAddress(MemberAddress memberAddress)
		throws SystemException {
		return updateMemberAddress(memberAddress, true);
	}
	...
	public MemberAddress updateMemberAddress(MemberAddress memberAddress,
		...
		memberAddress = memberAddressPersistence.update(memberAddress, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.library.slayer.model.MemberAddress",
			memberAddressLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.library.slayer.model.MemberAddress");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = memberAddressPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(MemberAddressLocalServiceBaseImpl.class);
