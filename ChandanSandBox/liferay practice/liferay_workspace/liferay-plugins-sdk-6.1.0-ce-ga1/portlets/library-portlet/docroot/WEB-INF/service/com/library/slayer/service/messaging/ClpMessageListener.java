...
package com.library.slayer.service.messaging;

import com.library.slayer.service.ClpSerializer;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			LMSBookJoinLocalServiceUtil.clearService();

			MemberAddressLocalServiceUtil.clearService();
		}
	}
}