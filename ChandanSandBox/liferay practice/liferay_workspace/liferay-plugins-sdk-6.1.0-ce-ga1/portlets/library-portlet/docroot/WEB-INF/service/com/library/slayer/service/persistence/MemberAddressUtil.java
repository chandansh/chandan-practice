...
/**
 * The persistence utility for the member address service. This utility wraps {@link MemberAddressPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class MemberAddressUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(MemberAddress memberAddress) {
		getPersistence().clearCache(memberAddress);
	}
	 ...
	 */
	public static List<MemberAddress> findWithDynamicQuery(
	 ...
	 */
	public static MemberAddress update(MemberAddress memberAddress,
		boolean merge) throws SystemException {
		return getPersistence().update(memberAddress, merge);
	}
	...
	public static MemberAddress update(MemberAddress memberAddress,
		...
		return getPersistence().update(memberAddress, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(memberAddress);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(memberAddresses);
	}
	...
	*/
	public static com.library.slayer.model.MemberAddress create(long userId) {
	...
	*/
	public static com.library.slayer.model.MemberAddress remove(long userId)
		throws com.library.slayer.NoSuchMemberAddressException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(userId);
	}

	public static com.library.slayer.model.MemberAddress updateImpl(
		com.library.slayer.model.MemberAddress memberAddress, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(memberAddress, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.library.slayer.model.MemberAddress findByPrimaryKey(
		long userId)
		throws com.library.slayer.NoSuchMemberAddressException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.library.slayer.model.MemberAddress fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.library.slayer.model.MemberAddress> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static MemberAddressPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (MemberAddressPersistence)PortletBeanLocatorUtil.locate(com.library.slayer.service.ClpSerializer.getServletContextName(),
					MemberAddressPersistence.class.getName());

			ReferenceRegistry.registerReference(MemberAddressUtil.class,
				"_persistence");
		}
	...
	public void setPersistence(MemberAddressPersistence persistence) {
	...
	private static MemberAddressPersistence _persistence;
}