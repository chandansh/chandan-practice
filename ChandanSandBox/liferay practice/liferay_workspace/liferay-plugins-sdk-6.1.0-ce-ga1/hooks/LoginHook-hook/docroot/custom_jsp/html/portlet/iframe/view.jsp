...
// line added by mpower
iframeSrc = getmodifiedURL(iframeSrc, themeDisplay);
...
<!-- function added by mpower -->
<%!
private String getmodifiedURL(String url , ThemeDisplay themeDisplay){
	...
	url=StringUtil.replace(url, "@@USER_NAME@@", String.valueOf(user.getScreenName()));
	url=StringUtil.replace(url, "@@ORGN_ID@@", String.valueOf(orgId));
	url=StringUtil.replace(url, "@@ORGN_NAME@@", orgName);
	return url;
}
