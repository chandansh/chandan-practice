...
package com.mpower.training.order.service.messaging;
...
import com.mpower.training.order.service.ClpSerializer;
import com.mpower.training.order.service.MyOrderLocalServiceUtil;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			MyOrderLocalServiceUtil.clearService();
		}
	}
