...
package com.mpower.training.customer.service.messaging;
...
import com.mpower.training.customer.service.ClpSerializer;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			MyCustomerLocalServiceUtil.clearService();
		}
	}
