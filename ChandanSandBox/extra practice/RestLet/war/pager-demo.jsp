...
<body bgcolor="#ffffff">
	<table bgcolor="#ffcc00" width="100%" border="0" cellspacing="0"
		cellpadding="2">
		<tr>
			<td><table bgcolor="#3366cc" width="100%" border="0"
					cellspacing="0" cellpadding="4">
					<tr>
						<td width="379"><a href="http://jsptags.com/"><img
								src="images/jsptags.gif" alt="&lt;jsptags.com&gt; logo"
								width="379" height="65" border="0"></a></td>
						<td width="100%" align="center"><a
							href="http://jsptags.com/tags/navigation/pager/" class="nodec"><font
								color="#ffffff" size="+2"><b> Pager Tag Library v2.0</b></font></a></td>
					</tr>
				</table></td>
		</tr>
	</table>
			...
			<table border="0" width="90%" cellpadding="4">
				<tr valign="top">
					<td rowspan="2" align="center">
						<table border="0" cellspacing="2" cellpadding="0">
							...
							<tr>
								<td>
									<%
										radio(pageContext, "style", "simple", true);
									%>
								</td>
								<td>Simple</td>
							</tr>
							<tr>
								<td>
									<%
										radio(pageContext, "style", "texticon", false);
									%>
								</td>
								<td>Text Icon</td>
							</tr>
							<tr>
								<td>
									<%
										radio(pageContext, "style", "jsptags", false);
									%>
								</td>
							...
							<tr>
								<td>
									<%
										radio(pageContext, "style", "alltheweb", false);
									%>
								</td>
								<td><a target="_blank" href="http://www.alltheweb.com/">AllTheWeb</a></td>
							</tr>
							<tr>
								<td>
									<%
										radio(pageContext, "style", "altavista", false);
									%>
								</td>
								<td><a target="_blank" href="http://www.altavista.com/">AltaVista</a></td>
							</tr>
							<tr>
								<td>
									<%
										radio(pageContext, "style", "google", false);
									%>
								</td>
								<td><a target="_blank" href="http://www.google.com/"><font
										color="#0000cc">G</font><font color="#cccc00">oo</font><font
										color="#0000cc">g</font><font color="#00cc00">l</font><font
										color="#cc0000">e</font></a></td>
							</tr>
							<tr>
								<td>
									<%
										radio(pageContext, "style", "lycos", false);
									%>
								</td>
								<td><a target="_blank" href="http://www.lycos.com/">Lycos</a></td>
							</tr>
							<tr>
								<td>
									<%
										radio(pageContext, "style", "yahoo", false);
									%>
								</td>
					...
					<td>
						<table border="0" cellspacing="2" cellpadding="0">
							...
							<tr>
								<td>
									<%
										radio(pageContext, "position", "top", true);
									%>
								</td>
								<td>Top</td>
							</tr>
							<tr>
								<td>
									<%
										radio(pageContext, "position", "bottom", false);
									%>
								</td>
								<td>Bottom</td>
							</tr>
							<tr>
								<td>
									<%
										radio(pageContext, "position", "both", false);
									%>
								</td>
								<td>Top&nbsp;&amp;&nbsp;Bottom</td>
							</tr>
					...
					<td>
						<table border="0" cellspacing="2" cellpadding="0">
							...
							<tr>
								<td>
									<%
										radio(pageContext, "index", "center", true);
									%>
								</td>
								<td>Center</td>
							</tr>
							<tr>
								<td>
									<%
										radio(pageContext, "index", "forward", false);
									%>
								</td>
								<td>Forward</td>
							</tr>
							<tr>
								<td>
									<%
										radio(pageContext, "index", "half-full", false);
									%>
								</td>
								<td>Half-Full</td>
							</tr>
					...
					<td rowspan="2" width="100%">
						<p>This demo of the Pager Tag Library displays the web safe
							color palette as its data source. Some of the available pager
							options may be changed using the adjacent form.</p> <%
							...
							<tr valign="top">
								...
								<td>JSPTags.com Emulation Settings<br>
									<table border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td>Max. Page Items:</td>
											<td>10</td>
										</tr>
										<tr>
											<td>Max. Index Pages:&nbsp;</td>
											<td>10</td>
										</tr>
									</table>
								</td>
 ...
 %>
						<table border="0" cellspacing="0" cellpadding="0">
							<tr valign="top">
								<td><input type="submit" value="Update"></td>
								<td>&nbsp;&nbsp;</td>
								<td><font color="#0000cc">G</font><font color="#cccc00">oo</font><font
									color="#0000cc">g</font><font color="#00cc00">l</font><font
									color="#cc0000">e</font> Emulation Settings<br>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>Index:</td>
											<td>Half-Full</td>
				...
				<tr>
					<td colspan="2" align="center" valign="top">
						<table border="0" cellspacing="2" cellpadding="0">
							<tr>
								<td>Max.&nbsp;Page&nbsp;Items&nbsp;</td>
								<td><input type="text" size="4" name="maxPageItems"
									value="<%=maxPageItems%>" onChange="this.form.submit();"></td>
							</tr>
							<tr>
								<td>Max.&nbsp;Index&nbsp;Pages&nbsp;</td>
								<td><input type="text" size="4" name="maxIndexPages"
									value="<%=maxIndexPages%>" onChange="this.form.submit();"></td>
							</tr>
						</table>
					</td>
				</tr>
