...
class PriorityDemo 
{
  public static void main(String args[])
   {
        ChildThread obj1 = new ChildThread(Thread.NORM_PRIORITY - 2,"1");
   	ChildThread obj2 = new ChildThread(Thread.NORM_PRIORITY + 2,"2");
    	ChildThread obj3 = new ChildThread(Thread.NORM_PRIORITY + 3,"3");
        obj1.t.start();
    	obj2.t.start();
    	obj3.t.start();
    	try
