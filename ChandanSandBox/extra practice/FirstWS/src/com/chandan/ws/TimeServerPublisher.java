...
public class TimeServerPublisher {
	 ...
	 * version, the first argument is the publication URL as a string and the
	 * second argument is an instance of the service SIB, in this case
	 * com.chandan.ws.TimeServerImpl.
	 * 
	...
	public static void main(String[] args) {
		...
		Endpoint.publish("http://127.0.0.1:9876/ws", new TimeServerImpl());
