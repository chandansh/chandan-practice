   ...
   //NVPCallerServiced object is taken from the session
	NVPCallerServices caller = (NVPCallerServices) session.getValue("caller");
 	...
 	try {
	   ...
	   encoder.add("METHOD","BillOutstandingAmount");
       encoder.add("PROFILEID",request.getParameter("profileId"));
       encoder.add("AMT",request.getParameter("amount"));
...
%>
 <br/>
<center><font size=2 color=black face=Verdana><b>Bill Outstanding Amount</b></font> <br>
<br>
