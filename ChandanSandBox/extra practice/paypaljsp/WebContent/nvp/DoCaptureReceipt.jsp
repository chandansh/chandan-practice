...
<%
	...
	try {
		...
		encoder.add("COMPLETETYPE",(String)request.getParameter("CompleteCodeType"));
		encoder.add("AMT",(String)request.getParameter("amount"));
		encoder.add("CURRENCYCODE",(String)request.getParameter("currency"));
		
		if(!Util.isEmpty((String)request.getParameter("invoiceID")))
		encoder.add("INVNUM",(String)request.getParameter("invoiceID"));
		...
		String ppresponse =
		    ...
		    String header1="Do Capture";
		    String header2="Authorization captured!";
